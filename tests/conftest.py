...
_ENV_VARS_TO_CLEAR = [
    ...
    "QDRANT_URL",
    # Memory
    "ARIA_MEMORY_BASE_PATH",
    "ARIA_MEMORY_DEFAULT_SCOPE",
    "ARIA_MEMORY_TOKEN_BUDGET",
    # Telegram
    "ARIA_TELEGRAM_BOT_TOKEN",
    "ARIA_TELEGRAM_CHAT_ID",
    "ARIA_TELEGRAM_ARIA_BASE_URL",
    "ARIA_TELEGRAM_ARIA_API_KEY",
    "ARIA_TELEGRAM_DEFAULT_SCOPE",
    "ARIA_TELEGRAM_DEFAULT_COLLECTION",
    "ARIA_TELEGRAM_REQUEST_TIMEOUT",
]
